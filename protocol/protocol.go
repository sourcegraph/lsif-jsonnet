...
const (
	// Version represents the current LSIF version of implementation.
	Version = "0.4.0"
...
func NewEvent(id int, kind, scope string, data int) *Event {
	return &Event{
		Vertex: Vertex{
			Element: Element{
				ID:   id,
...
// StartPos contains the precise position information.
type Pos struct {
...
func NewMoniker(id int, kind, scheme, identifier string) *Moniker {
	return &Moniker{
		Vertex: Vertex{
			Element: Element{
				ID:   id,
...
func NewPackageInformation(id int, name, manager, version string) *PackageInformation {
...
func NewNext(id, outV, inV int) *Next {
	return &Next{
		Edge: Edge{
			Element: Element{
				ID:   id,
...
func NewContains(id, outV int, inVs []int) *Contains {
	return &Contains{
		Edge: Edge{
			Element: Element{
				ID:   id,
...
func NewTextDocumentDefinition(id, outV, inV int) *TextDocumentDefinition {
...
// vertices information.
func NewTextDocumentHover(id, outV, inV int) *TextDocumentHover {
...
// vertices information.
func NewTextDocumentReferences(id, outV, inV int) *TextDocumentReferences {
...
func NewItem(id, outV int, inVs []int, document int) *Item {
	return &Item{
		Edge: Edge{
			Element: Element{
				ID:   id,
...
func NewItemWithProperty(id, outV int, inVs []int, document int, property string) *Item {
...
func NewItemOfDefinitions(id, outV int, inVs []int, document int) *Item {
...
func NewItemOfReferences(id, outV int, inVs []int, document int) *Item {
...
func NewMonikerEdge(id, outV, inV int) *MonikerEdge {
	return &MonikerEdge{
		Edge: Edge{
			Element: Element{
				ID:   id,
...
func NewNextMonikerEdge(id, outV, inV int) *NextMonikerEdge {
...
func NewPackageInformationEdge(id, outV, inV int) *PackageInformationEdge {
